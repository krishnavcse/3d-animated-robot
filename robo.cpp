...
GLUquadricObj *qobj;
char leg = 0;
int shoulder1=0,shoulder2=0,shoulder3=0,shoulder4=0,lat1=20, lat=20,elbow1=0,elbow2=0,pivot=0,tilt=10,ankle1=0,ankle2= 0, heel1 = 0,heel2 = 0, hip11 = 0, hip12 = 10, hip21 = 0, hip22 = 10, fire = 0, solid_part = 0,anim = 0, turn = 0, turn1 = 0, lightturn = 0, lightturn1 = 0;
...
void display(void)
{
 ...
 glLoadName(TEXTID);
 glColor3f(1,1,0);
 DrawTextXY(-2.5,0.2,2.0,0.0015,".");
 DrawTextXY(-2.5,0.5,2.0,0.0015,".");
 DrawTextXY(2.5,2.2,-2.0,0.0025,".");
